...
const routes: Routes = [
  ...
  { path: 'profile', loadChildren: () => import("./modules/profile/profile.module").then((m) => m.ProfileModule), canActivateChild: [userGuard]},
  {path: 'favorite', loadChildren: () => import("./modules/favorite/favorite.module").then((m) => m.FavoriteModule), canActivate: [userGuard]},
